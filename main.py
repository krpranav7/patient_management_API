...
class Patient(BaseModel):
    ...
    city: Annotated[str, Field(..., description='city where patieent is living')]
...
def view_patient(patient_id:str = Path(..., description='ID of patient in DB', openapi_examples='P001')):
    data=load_data()
